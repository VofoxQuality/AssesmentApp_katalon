...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SEBAST~1.VOF\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Manage Employees Department\\TCA095002\\20180920_202026\\execution.properties')
...
not_run: WebUI.click(findTestObject('Page_/a_ Manage Employees Department'))

not_run: WebUI.selectOptionByValue(findTestObject('Page_/select_AllEmployeeNHIP Number'), 'Employee', true)

not_run: WebUI.delay(2)

not_run: WebUI.verifyTextPresent('Enter NHIP Number/', false)

not_run: WebUI.selectOptionByValue(findTestObject('Page_/select_AllEmployeeNHIP Number'), 'Nhip', true)

not_run: WebUI.verifyTextPresent('Enter NHIP Number/', false)

not_run: WebUI.verifyElementClickable(findTestObject('Page_/input_ctl00adminContentPlaceHo_searchbox'))

not_run: WebUI.selectOptionByValue(findTestObject('Page_/select_AllEmployeeNHIP Number'), 'Employee', true)

not_run: WebUI.click(findTestObject('Page_/input_ctl00adminContentPlaceHo_search'))

not_run: WebUI.verifyElementText(findTestObject('Page_/td_Sorry No Employees  Found..'), 'Sorry No Employees Found...')

not_run: WebUI.verifyElementText(findTestObject('Page_/th_First Name'), 'First Name')

not_run: WebUI.verifyElementText(findTestObject('Page_/th_Last Name'), 'Last Name')
