...
WebUI.verifyElementText(findTestObject('Page_Admin Login/span_Enter Username'), 'Enter Username')

WebUI.verifyElementText(findTestObject('Page_Admin Login/span_Enter Password'), 'Enter Password')
